            ...
            <div className="contai" style={{ marginTop: "20px" }} >
                <div className="admin">
                    ...
                    <div style={{ margin: "10px", justifyContent: "center" }}>
                        ...
                        Welcome to our website. If you continue to browse and use this website you are agreeing to comply with and be bound by the following terms and conditions of use, which together with our privacy policy govern AgriExpert''s relationship with you in relation to this website.

                        The term 'AgriExpert' or 'us' or 'we' refers to the owner of the website whose registered/operational office is TRIVENI PATH, CHANDAN NAGAR, SACHAL ROAD, Guwahati Kamrup Metropolitan ASSAM 781022. The term 'you' refers to the user or viewer of our website.
                        ...
                        You may not create a link to this website from another website or document without AgriExpert’s prior written consent.
