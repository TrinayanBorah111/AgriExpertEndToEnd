            ...
            <div className="contai" style={{ marginTop: "20px"}} >
                <div className="admin">
                    ...
                    <div style={{ margin: "10px", justifyContent: "center" }}>
                        ...
                        This privacy policy sets out how AgriExpert uses and protects any information that you give AgriExpert when you use this website.

                        AgriExpert is committed to ensuring that your privacy is protected. Should we ask you to provide certain information by which you can be identified when using this website, and then you can be assured that it will only be used in accordance with this privacy statement.

                        AgriExpert may change this policy from time to time by updating this page. You should check this page from time to time to ensure that you are happy with any changes.
                        ...
                        if you have previously agreed to us using your personal information for direct marketing purposes, you may change your mind at any time by writing to or emailing us at agriexpert2023@gmail.com
